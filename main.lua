...
local workspace, window, menu = system.addWindow(GUI.filledWindow(1, 1, 50, 16, 0x005bff))
 
local layout = window:addChild(GUI.layout(1, 1, window.width, window.height, 1, 1))
 
local label = layout:addChild(GUI.label(1, 1, 25, 1, 0xFFFFFF, "Gazon Manager, Что хотите сделать?:"))
